...
const Navigation = (props) => {
    const {currentPage, setCurrentPage, wipeProjectId} = props
        ...
        <Navbar collapseOnSelect={true} className="navigation" expand="sm">            
            ...
            <Navbar.Collapse className="ms-4" style={{fontSize: "100px"}}>
                ...
                <Nav className="ms-auto">
                    <NavDropdown.Item as="button" eventKey={1} className="mt-2 me-4 navLink" active={currentPage === "projectIndex" ? true : false}
                        onClick={() => {
                            setCurrentPage("projectIndex")
                            wipeProjectId()
                        }}
                    >Projects</NavDropdown.Item>
                    <NavDropdown.Item as="button" eventKey={2} className="mt-2 me-4 navLink" active={currentPage === "about" ? true : false}
                        onClick={() => {
                            setCurrentPage("about")
                            wipeProjectId()
                        }}
                    >Who?</NavDropdown.Item>

                    <NavDropdown.Item as="button" onClick={() => {window.open("/portfolio/hbResume.pdf", "_blank")}}  className="mt-2 me-3 navLink" download>Resume
